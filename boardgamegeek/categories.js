...
(function(){
  ...
  var file="categories.txt"
  var base="xml sel -n -T -t -m \"/boardgames/boardgame[@objectid='__ID__']\" -v \"concat(./boardgamecategory[1],',',./boardgamecategory[2],',',./boardgamecategory[3],',',./boardgamecategory[4])\" top200.xml >>"+file;
